...
**สถานะการแก้ (อัปเดต 12 ก.ค. 2026): เฟส 1 แก้เสร็จแล้ว** — ดูรายละเอียดท้ายไฟล์ (§ บันทึกการแก้ไข)
เฟส 2 และ 3 ยังไม่ได้ทำ
...
## ยังไม่ได้แก้ (เฟส 2-3)

H2 (ledger ซ้ำ 2 ระบบ), H3 (backend cache), H6 (Groq truncation — แก้แล้วบางส่วนผ่าน `analysis/llm.py`), **H7 (macro CPI: ยืนยันแล้วว่า `CPIAUCSL` คืน 404 จาก Yahoo จริง)**, H8 (ORM serialization), M2-M13 ที่เหลือ, การกู้ป้ายภาษาไทยใน dashboard (M6), auth บน backend, เอกสาร

---

*รายงานตรวจสร้างจากการอ่านโค้ด ณ commit `5a33408`; การแก้เฟส 1 ทดสอบด้วย venv Python 3.12 + dependencies ที่ pin แล้ว*
